...
def insert_product(conn, product):
    ...
    cursor.execute("SET IDENTITY_INSERT Products ON;")  # 啟用IDENTITY_INSERT
    cursor.execute("INSERT INTO Products (ProductID, ProductName, Price, StockQuantity) VALUES (?, ?, ?, ?)", product[0], product[1], product[2], product[3])
    cursor.execute("SET IDENTITY_INSERT Products OFF;")  # 禁用IDENTITY_INSERT
